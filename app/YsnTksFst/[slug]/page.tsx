    ...
    return (
      <div className="min-h-screen pt-20 px-4 sm:px-6 lg:px-8 bg-white dark:bg-black flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/ysntksfst" className="text-blue-600 dark:text-blue-400 hover:underline">
            Back to all posts
          </Link>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <article className="prose prose-lg max-w-none">
          ...
          <div className="mt-16 p-8 bg-gray-50 dark:bg-gray-900 border-2 border-gray-200 dark:border-gray-800 rounded-lg">
            <h3 className="text-xl font-bold text-black dark:text-white mb-4">Share this post</h3>
            <div className="flex gap-4">
              ...
              <button className="px-4 py-2 border border-black dark:border-white text-black dark:text-white rounded-lg hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-black transition-colors">
                Share on Twitter
              </button>
            </div>
          </div>
